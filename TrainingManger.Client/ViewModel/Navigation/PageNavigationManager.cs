...
using TrainingManger.Client.View.TabbedPageView.OneRepMaxPage;
using Utility;
...
#warning Refact required: PageNavigationManager
    public class PageNavigationManager
    {
        ...
        private StatisticsPage _oneRepetitionMaximumCalculatorPage;
        ...
        private void InitializePages()
        {
            try
            {
                ...
                _oneRepetitionMaximumCalculatorPage = new StatisticsPage();
                ...
                _mainTabbedPage.SelectedTabColor = Color.FromRgb(255,255,255);
        ...
        //EVENT HANDLERS
        private async void OnPopUpMessage(object send, MessageContent message) =>
        ...
        private async void OnPopUpMessage(object sender, (MessageContent message, Action Callback) e)
        {
