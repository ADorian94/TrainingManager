    ...
    public class RegistrationManagerVM : ViewModelBase
    {
            ...
            if (ArePreconditionsFine())
            {
                ...
                if (registrationResult)
                {
                    ...
                    else
                    {
                        ...
                        SendPopUpMessage(MessageContent.LoginFailedAfterRegistration);
                    }
                ...
                else
                {
                    ...
                    SendPopUpMessage(MessageContent.RegistrationFailed);
                }
        ...
        private bool ArePreconditionsFine()
        {
            if (string.IsNullOrEmpty(Name))
            {
                ...
                SendPopUpMessage(MessageContent.RequiredFirstName);
                return false;
            }
            ...
            if (string.IsNullOrEmpty(UserName))
            {
                ...
                SendPopUpMessage(MessageContent.RequiredUserName);
                return false;
            }
            ...
            if (string.IsNullOrEmpty(UserEmail))
            {
                ...
                SendPopUpMessage(MessageContent.RequiredEmail);
                return false;
            }
            ...
            if (string.IsNullOrEmpty(Password))
            {
                ...
                SendPopUpMessage(MessageContent.RequiredPassword);
                return false;
            }
            ...
            if (string.IsNullOrEmpty(ConfirmPassword))
            {
                ...
                SendPopUpMessage(MessageContent.RequiredConfirmPassword);
                return false;
            }
            ...
            if (Password != ConfirmPassword)
            {
                ...
                SendPopUpMessage(MessageContent.PasswordsAreNotEquals);
                return false;
            }
